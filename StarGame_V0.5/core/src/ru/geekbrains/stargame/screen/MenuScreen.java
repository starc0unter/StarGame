...
public class MenuScreen extends Base2DScreen implements ActionListener {
    ...
    public void show() {
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("sound/intro.mp3"));
        backgroundMusic.setLooping(true);
        backgroundMusic.play();

        menuClicked = Gdx.audio.newSound(Gdx.files.internal("sound/menuClick.wav"));
    }
